...
//
// public ChatDemo(@Qualifier("MainChatService") ChatService chatService,
...
// handlePdfUpload(event.getFileName()));
...
// imageUpload.setDropLabel(new Span("Drop your image here or click to
// upload"));
// imageUpload.addSucceededListener(event ->
// handleImageUpload(event.getFileName()));
...
// HorizontalLayout fileUploadsLayout = new HorizontalLayout(pdfLayout,
// imageLayout);
...
// VerticalLayout chatLayout = new VerticalLayout(message, submitButton,
// chatHistoryLayout);
...
// }
//
// private void addMessageWithEmoji(String sender, String content, boolean
// isAssistant, boolean isMarkdown) {
...
//
// addMessageWithEmoji("User", chatInput, /* isAssistant= */false, /*
// isMarkdown= */true);
//
...
// addMessageWithEmoji("ITUKI", response, /* isAssistant= */true, /* isMarkdown=
// */true);
// message.setValue("");
// ui.push();
// });
