...
public class ChatController {
    ...
    public ChatController(ChatService chatService, DataService dataService) {
    ...
    public Mono<ResponseEntity<ExtractTextResponse>> extractText(@RequestParam("file") MultipartFile file) {
        try{
    ...
    public Mono<ResponseEntity<ExtractImageResponse>> extractImage(@RequestParam("file") MultipartFile file) {
        try{
