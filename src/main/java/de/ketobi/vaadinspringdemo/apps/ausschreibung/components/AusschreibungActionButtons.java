...
public class AusschreibungActionButtons extends HorizontalLayout {
        ...
        private void showConfirmationDialog(Ausschreibung ausschreibung, AusschreibungService service) {
                ...
                VerticalLayout content = new VerticalLayout(
                                new Span(
                                                "Das Ausschreibungsprojekt wurde erfolgreich angelegt, und nun beginnt die spannende Phase der Detailarbeit."),
                                ...
                                new Span(
                                                "Sie haben nun die Möglichkeit, direkt ins Projekt einzutauchen oder zur Home-Oberfläche zurückzukehren."));
